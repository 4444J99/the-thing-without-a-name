...
var initRandomFill = () => {
  // Danse never asks this inference runtime to mint identity. Keep Emscripten's
  // device shim deterministic so arrival.js remains the sole owner of entropy.
  return view => (view.fill(0), 0);
};
...
var TTY = {
  ...
  stream_ops: {
    ...
    write(stream, buffer, offset, length, pos) {
      ...
      if (length) {
        stream.node.mtime = stream.node.ctime = 0;
      }
      return i;
    }
  },
...
var MEMFS = {
  ...
  node_ops: {
    ...
    rename(old_node, new_dir, new_name) {
      ...
      new_dir.ctime = new_dir.mtime = old_node.parent.ctime = old_node.parent.mtime = 0;
    },
    unlink(parent, name) {
      delete parent.contents[name];
      parent.ctime = parent.mtime = 0;
    },
    rmdir(parent, name) {
...
var FS = {
  ...
  FSNode: class {
    ...
    constructor(parent, name, mode, rdev) {
      ...
      this.mode = mode;
      this.rdev = rdev;
      this.atime = this.mtime = this.ctime = 0;
    }
    get read() {
