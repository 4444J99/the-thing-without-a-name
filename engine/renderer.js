...
uniform vec3 uTint;        // per-panel photographic colour grade
uniform vec3 uFilter;      // contrast, saturation, translucent bleed
...
void main() {
  ...
  c = mix(vec3(luma), c, uFilter.y);
  c = (c - 0.5) * uFilter.x + 0.5;
  c = mix(c, c * uTint, uFilter.z);
